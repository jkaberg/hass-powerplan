...
| `core/pricing/modifiers/tou_urdb.py` (paste a URDB rate) | a US household pastes JSON | becomes the `openei_urdb` adapter's energy half; the paste option is removed | TS.5 - **done** (D-0578) |
