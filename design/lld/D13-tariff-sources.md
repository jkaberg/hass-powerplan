...
| G22 | a grid energy charge that is a share of the hour's spot price (loss compensation) | SE Kraftringen, Skånska Energi (5 %), E.ON capacity tariffs (1.6 %) | the grid's energy charge is fixed per period | `EnergyVersion.spot_share` (D-0570) | D1 §5.3, D13 §3 | TS.4 | S |
