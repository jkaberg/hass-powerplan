"""`es_contracted@1` - one of D9 §5.9's "other houses".

The spec is `tests/builders/houses.py`'s `es_contracted()`; this module names it for the
...
from tests.builders.houses import (
    ALL_LOADS,
    ES_CONTRACTED_HOUSE_ID,
    ES_CONTRACTED_SOURCES,
    es_contracted,
)
...
NAME = "es_contracted"
VERSION = ES_CONTRACTED_HOUSE_ID
SOURCES = ES_CONTRACTED_SOURCES
