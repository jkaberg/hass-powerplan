...
from tests.core.allocation.conftest import FUSE_W, PerfectBaseline, ceiling, meter
...
@pytest.mark.inv("INV-62")
def test_03_an_unconfident_baseline_changes_nothing() -> None:
    """Below `BASELINE_CONFIDENCE` the projection and reserve stay as they were."""
    snapshot = meter(used_kwh=6.0, t_rem_h=0.5, sigma_w=0.0)
    shy = PerfectBaseline(confidence=0.4)
